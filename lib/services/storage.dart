...
class Storage extends Service {
    Storage(Client client): super(client);
     ...
     ///
     Future<FileListModel> listFiles({String search = '', int limit = 25, int offset = 0, OrderType orderType = OrderType.asc}) async {
     ...
     ///
     Future<FileModel> createFile({required FileInput file, List read = const [], List write = const []}) async {
        final String path = '/storage/files';
     ...
     ///
     Future<Uint8List>  getFilePreview({required String fileId, int width = 0, int height = 0, int quality = 100, int borderWidth = 0, String borderColor = '', int borderRadius = 0, int opacity = 1, int rotation = 0, String background = '', String output = ''}) async {
